...
class CustomDataset(Dataset):
    def __init__(self, data_length, L, filter_size, mod_scheme, seed, test = False):
        ...
        if test != True:
            ...
            target_np_name = 'filter_target_len_{}_filter_size_{}_mod_{}_S_{}'.format(data_length // L, filter_size, mod_scheme, seed)
