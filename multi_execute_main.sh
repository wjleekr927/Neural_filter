...
do
    for bs in 250 500
    do
        for idx in 405 405 405 405 405 405 405 405
        do
            ...
            #python main.py --epochs 360 --lr 1e-7 --filter_type "NN" --decision_delay 7 --mod_scheme '16QAM' --RX_num 2 --total_taps 8 --filter_size 8 --SNR 20 --rand_seed_channel $idx --rand_seed_train 9001 --rand_seed_test 4001 --train_seq_len 6000000 --test_seq_len 18000000 --bs 500 --exp_num 1 #--scatter_plot
            python main.py --epochs $epochs --lr 4e-6 --filter_type "NN" --decision_delay 7 --mod_scheme 'QPSK' --RX_num 2 --total_taps 8 --filter_size 8 --SNR 20 --rand_seed_channel $idx --rand_seed_train 9001 --rand_seed_test 4001 --train_seq_len 3000000 --test_seq_len 9000000 --bs $bs --exp_num 1 #--scatter_plot
        done
    done
done