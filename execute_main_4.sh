...
# Fourth exp (SNR)
for SNR in 35 #0 5 10 15 20 25 30 35 40
do
    for idx in 927 405 6438 2169 #927 3438 405 6438 2169
    do
        #python main.py --filter_type "LMMSE" --decision_delay 7 --RX_num 2 --total_taps 8 --filter_size 8 --SNR $SNR --rand_seed_channel $idx --rand_seed_train 9001 --rand_seed_test 4001 --train_seq_len 150000 --test_seq_len 9000000 --exp_num 4
        python main.py --filter_type "LS" --decision_delay 7 --RX_num 2 --total_taps 8 --filter_size 8 --SNR $SNR --rand_seed_channel $idx --rand_seed_train 9001 --rand_seed_test 4001 --train_seq_len 900000 --test_seq_len 9000000 --exp_num 4
        #python main.py --epochs 360 --lr 1e-7 --filter_type "NN" --decision_delay 7 --RX_num 2 --total_taps 8 --filter_size 8 --SNR $SNR --rand_seed_channel $idx --rand_seed_train 9001 --rand_seed_test 4001 --train_seq_len 300000 --test_seq_len 9000000 --bs 200 --exp_num 4
    done
done